   ...
   : _ssss( from. _ssss )
{
   ...
   case MakeStructStmt:
      tvm::init( repr. _fld12. loc, from. repr. _fld12. loc );
   ...
   case MatchStmt:
      ...
      break;
   case VarInitStmt:
      tvm::init( repr. _fld14. loc. first, from. repr. _fld14. loc. first );
      tvm::init( repr. _fld14. loc. second, from. repr. _fld14. loc. second );
   ...
   : _ssss( from. _ssss )
{
   ...
   case MakePropertyStmt:
   case MakeStructStmt:
      tvm::init( repr. _fld12. loc, std::move( from. repr. _fld12. loc ) );
      tvm::destroy( from. repr. _fld12. loc );
   ...
   case MatchStmt:
      ...
      break;
   case VarInitStmt:
      tvm::init( repr. _fld14. loc. first, std::move( from. repr. _fld14. loc. first ) );
      tvm::destroy( from. repr. _fld14. loc. first );
      tvm::init( repr. _fld14. loc. second, std::move( from. repr. _fld14. loc. second ) );
      tvm::destroy( from. repr. _fld14. loc. second );
...
const val::Statement & val::Statement::operator = ( Statement&& from ) noexcept
{
   if( _ssss == from. _ssss )
   {
      ...
      case MakePropertyStmt:
      case MakeStructStmt:
         tvm::assign( repr. _fld12. loc, std::move( from. repr. _fld12. loc ) );
         tvm::destroy( from. repr. _fld12. loc );
      ...
      case MatchStmt:
         ...
         break;
      case VarInitStmt:
         tvm::assign( repr. _fld14. loc. first, std::move( from. repr. _fld14. loc. first ) );
         tvm::destroy( from. repr. _fld14. loc. first );
         tvm::assign( repr. _fld14. loc. second, std::move( from. repr. _fld14. loc. second ) );
         tvm::destroy( from. repr. _fld14. loc. second );
...
val::Statement::~Statement( ) noexcept
{
   ...
   case MatchStmt:
      ...
      break;
   case VarInitStmt:
      tvm::destroy( repr. _fld14. loc. first );
      tvm::destroy( repr. _fld14. loc. second );
      dropshare( repr. _fld14. heap );
      break;
   }
}
...
bool val::Statement::very_equal_to( const Statement & other ) const
{
   ...
   case MakePropertyStmt:
   case MakeStructStmt:
      if( tvm::distinct( repr. _fld12. loc, other. repr. _fld12. loc ))
         return false;
   ...
   case MatchStmt:
      ...
      return true;
   case VarInitStmt:
      if( tvm::distinct( repr. _fld14. loc. first, other. repr. _fld14. loc. first ))
         return false;
      if( tvm::distinct( repr. _fld14. loc. second, other. repr. _fld14. loc. second ))
         return false;
