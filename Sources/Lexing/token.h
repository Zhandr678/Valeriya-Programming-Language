...
enum class TokenLabel
{
	...
	LIT_NUMBER, LIT_STRING, LIT_BOOL, LIT_NULL,
...
inline std::ostream& operator<<(std::ostream& out, TokenLabel label) {
    switch (label) {
        ...
        case TokenLabel::LIT_BOOL:    return out << "LIT_BOOL";
        ...
        case TokenLabel::COM_BEGIN:   return out << "COM_BEGIN";
